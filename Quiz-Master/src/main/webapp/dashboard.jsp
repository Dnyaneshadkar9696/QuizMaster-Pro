...
```
css id ="lcm2vg "
	/* Funny Quiz Animation Section */ .quiz-animation {
	margin-top: 50px;
	background: white;
	border-radius: 28px;
	padding: 40px;
...
<body>
	<div class="navbar">
		<div class="brand">
			...
			<div>
				...
				<div style="font-size: 12px; color: rgba(234, 242, 255, 0.7)">Welcome
					to your dashboard</div>
			</div>
		</div>
		<div style="display: flex; gap: 12px; align-items: center">
			<a href="add-question.jsp"
				style="color: inherit; text-decoration: none; padding: 8px 12px; border-radius: 8px; background: rgba(255, 255, 255, 0.02)">Add
				Question</a> <a href="LogoutServlet"
				style="color: inherit; text-decoration: none; padding: 8px 12px; border-radius: 8px; background: rgba(255, 255, 255, 0.02)">Logout</a>
		</div>
	</div>
	...
	<div class="container">
		...
		<div id="successMsg"
			style="background: #d4edda; color: #155724; padding: 12px; margin-bottom: 20px; border-radius: 8px; font-weight: bold; transition: opacity 0.5s;">
